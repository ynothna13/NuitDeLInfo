...
<html lang="fr">
	<head>
		...
		<!--
			...
			<link rel="stylesheet" media="screen and (min-width: 1240px)" href="large-screen-layout.css" />
		-->
...
ON V.marque = M.id_marque WHERE 1=1 '. $critereUtilisation.' ' .
					$prix.' '.
					$critereAccessibilite.' '.
					$critereSituation.' '.
					$critereConduite.' '.
					...
					$critereOrigine.' '.
					$critereTransmission.' '.
					$critereSexe.' ORDER BY budget LIMIT 0 , 10';
					...
					$tab[13] = "5";
					$tab[14] = "5";
					$tab[15] = "http://static.latribune.fr/129545/citroenc4-picasso.jpg";
					...
					for($i=0; $i < 5; $i++)
					{
						echo "
						<div id='jvoiture' >
							<div id='jimage' style='background:url(".$tab[15]."); background-size: cover;'  ></div>
							<div id='jtitre' class='jpremierecol'>".$tab[11]." ".$tab[12]."</div>
							<div id='jcarburant' class='jpremierecol'>".$tab[0]."</div>
							<div id='jlabelprix' class='jpremierecol'> * Prix conseillé </div>
							<div id='jprix' class='jpremierecol'>".$tab[1]."</div>
							
							<div id='jlabelcaracteristique'> Caracteristiques </div>
							<div id='jroute' class='jdeuxiemecol'> <b>Style:</b> ".$tab[2]." </div>
							<div id='jboite' class='jdeuxiemecol'> <b>Boite de vitesse: </b>".$tab[8]." </div>
							<div id='jfinition' class='jdeuxiemecol'> <b>Finition: </b>".$tab[5]."  </div>
							<div id='jportes' class='jdeuxiemecol'> <b>Nombre de portes: </b>".$tab[14]." </div>
							<div id='jplaces' class='jdeuxiemecol'> <b>".$tab[14]." places</b> </div>
							<div id='jorigine' class='jdeuxiemecol'> <b>Origine: </b>".$tab[7]." </div>
							<div id='jconduite' class='jdeuxiemecol'> <b>Conduite: </b>".$tab[4]."  </div>
							
							<div id='jlabelconcess' > <a href='https://maps.google.fr/maps?q=garage+".$tab[11]."'> Trouver un concessionnaire </a> </div>
						</div>
						";
					}*/
				?>
